class AddFriendResponseModel {
  ...
  AddFriendResponseModel({this.status, this.message, this.data});
  ...
  AddFriendResponseModel copyWith({bool? status, String? message, Data? data}) =>
...
class Data {
  Data({this.userIdPK, this.firstName, this.lastName, this.email, this.referalCode});
