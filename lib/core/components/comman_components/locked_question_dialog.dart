...
class LockedQuestionDialog extends StatelessWidget {
            ...
            child: Container(
              ...
              child: Column(
                ...
                const  SizedBox(height: 16),
                  // Lock icon
                  Image.asset(Images.lock_white_ic, width: 50, height: 50),
                  const SizedBox(height: 24),

                  // Title
                   Text(
                    'This $title is locked',
