...
class CallActionButton extends StatelessWidget {
  ...
  const CallActionButton({super.key, this.isLoadingState = false, this.enable = true, required this.onPressed, required this.child});
  @override
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: RadialGradient(
            colors:
            enable
                ? [AppColors.primaryColorDark, AppColors.primaryColorDark]
                : [
              AppColors.redColor,

              AppColors.redColor, // Gray-400
            ],
